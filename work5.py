...
# โหลดภาพ oak.jpg และให้ระบบจดจำใบหน้า
person1_image = face_recognition.load_image_file("img/gor.jpg")
person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

# โหลดภาพ birth.jpg และให้ระบบจดจำใบหน้า
person2_image = face_recognition.load_image_file("img/gao.jpg")
person2_face_encoding = face_recognition.face_encodings(person2_image)[0]

# สร้าง list  arrays ของคนที่จดจำและกำหนดชื่อ ตามลำดับ
